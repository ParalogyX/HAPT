...
header-includes:
- \usepackage{titling}
- \pretitle{\begin{center}\LARGE\includegraphics[width=6cm]{./report_files//HarvardX.jpg}\LARGE\includegraphics[width=3cm]{./report_files//edx.png}\\[\bigskipamount]\vspace{5cm}}
...
output: 
  pdf_document: 
    ...
    fig_height: 3
    includes:
      in_header: ./report_files//preamble.tex
...
if (!dir.exists("./report_files")) {
  dir.create("./report_files")
}

# Download pictures and preamble if they are not downloaded yet
if (!file.exists("./report_files//HarvardX.jpg")) {
  download.file("https://raw.githubusercontent.com/ParalogyX/HAPT/master/report_files/HarvardX.jpg", "./report_files//HarvardX.jpg", mode = "wb")
}
if (!file.exists("./report_files//edx.png")) {
  download.file("https://raw.githubusercontent.com/ParalogyX/HAPT/master/report_files/edx.png", "./report_files//edx.png", mode = "wb")
}
if (!file.exists("./report_files//preamble.tex")) {
  download.file("https://raw.githubusercontent.com/ParalogyX/HAPT/master/report_files/preamble.tex", "./report_files//preamble.tex")
}
...
var_explained[1:100,] %>%
  ...
  theme(plot.title = element_text(hjust = 0.0, size = 40),
        ...
        axis.title=element_text(size=30))
```
As we can see on Figure 4, almost half of variances can be explained by one principal component. But looking on the total variance explained by principal components (Figure 5), we can see, that to explain at least 95% of variance, we need more than 100 principal components. Conclusion is that our data space is indeed very multidimensional.

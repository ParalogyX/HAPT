...
if (!file.exists("./report_files//HarvardX.jpg")) {
  download.file("http://archive.ics.uci.edu/ml/machine-learning-databases/00341/HAPT%20Data%20Set.zip", "./report_files//HarvardX.jpg")
}
if (!file.exists("./report_files//edx.png")) {
  download.file("http://archive.ics.uci.edu/ml/machine-learning-databases/00341/HAPT%20Data%20Set.zip", "./report_files//edx.png")
}
if (!file.exists("./report_files//preamble.tex")) {
  download.file("http://archive.ics.uci.edu/ml/machine-learning-databases/00341/HAPT%20Data%20Set.zip", "./report_files//preamble.tex")
}

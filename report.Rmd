...
```{r features_stats, echo=FALSE, warning=FALSE, message=FALSE, fig.cap = "Feature summary", fig.align='center', fig.height= 5}
...
grid.arrange(plot_min, plot_max, plot_median, plot_mean, ncol=2, top = textGrob("Feature summary",gp=gpar(fontsize=16,font=1), x = 0.07, hjust = 0))
...
```{r low_var_features_by_class_distr}
...
#do.call("grid.arrange", c(trends, ncol=4, top = textGrob("ggg",gp=gpar(fontsize=16,font=1), x = 0.07, hjust = 0)))
grid.arrange(grobs = trends, ncol=3, top = textGrob("ggg",gp=gpar(fontsize=16,font=1), x = 0.07, hjust = 0))
#trends[1]
#grid.arrange(grobs = list(trends[[1]], trends[[2]]))
